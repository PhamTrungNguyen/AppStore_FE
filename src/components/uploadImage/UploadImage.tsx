  ...
  return (
    <div className="flex gap-x-[50px]">
      ...
      <div className="">
        ...
        {!URL_2 && !image2 && (
          <div
            className={`cursor-pointer font-medium p-[10px] border-[2px] border-transparent bg-[#e22d28]  text-white hover:bg-white hover:text-[#e22d28] hover:border-[#e22d28] duration-300 text-[15px] text-center rounded-[10px] h-[35px] w-[150px] relative `}
          >
            <input
